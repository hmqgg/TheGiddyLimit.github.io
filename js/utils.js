...
Parser.SKILL_JSON_TO_FULL = {
	...
	"动物驯养": [
		"每当不确定你是否能够安抚家畜、使坐骑不受惊吓、或推断出动物的意图时，DM可能会要求一次感知（动物驯养）检定。当你尝试控制你的坐骑进行一些危险动作时，你也需要进行一次感知（动物驯养）检定。"
	],
	"奥秘": [
	...
	"察言观色": [
		"你的感知（察言观色）检定决定你是否能办别另一个生物真正的意图，例如辨别谎言或是预测某人的下一步。这样做涉及了从对方的身体语言、说话习惯、以及态度转变等行为中搜集线索。"
	],
	"威吓": [
	...
	"医药": [
		"一次感知（医药）检定能让你尝试稳定一个濒死同伴的伤势或者诊断疾病。"
	],
	"自然": [
		"你的智力（自然）检定被用以衡量你回忆关于地势、动植物、气候、以及自然周期等相关知识的能力。"
	],
	"察觉": [
		"你的感知（察觉）检定让你能够透过看、听、或其他方式来发现某些东西的存在。它代表着你对周围环境的总体意识以及你感官的敏锐度。", "举例来说，你可以会尝试聆听门后的对话、在敞开的窗户下窃听、或听见在森林中悄声移动的怪物。或者，你可能会试着看见被遮蔽或容易看走眼的东西，无论它们是在前路埋伏的兽人、躲在暗巷里的混混、还是从紧闭的暗门门鏠中透出的烛光。"
	],
	"表演": [
	...
	"求生": [
		"DM可能会要求你进行一次感知（求生）检定以追寻踪迹、狩猎野味、带领你的队伍穿越冰原、辨识枭头熊生活于附近的征兆、预测天气、或者避开流沙以及其他自然危险。"
	]
};
...
Parser.ACTION_JSON_TO_FULL = {
	...
	"搜寻": [
		"当你采取搜寻动作，你将全神投入于找寻某个事物。根据你搜寻方式的性质，DM可能会要求你进行一次感知（察觉）检定或一次智力（调查）检定。"
	],
	"使用物件": [
